        ...
        if key == "text":
            ...
            for elem in features:
                ...
                try:
                    ...
                    elif elem["embodiment_id"] == embodiment_tag_mapping[EmbodimentTag.PDM_LITE.value]:
                        processed_item = processed_item  # language instruction already self-contained
                    else:
                    ...
                    if num_views > 1 and elem["embodiment_id"] == embodiment_tag_mapping[EmbodimentTag.AGIBOT.value]:
                        ...
                        item = str(item)  # language instruction already self-contained
                    else:
                        raise ValueError(f"Embodiment ID {elem['embodiment_id']} not supported.")   
